...
import { Bell, ChevronDown, LogOut, User as UserIcon, Store } from 'lucide-react';
          ...
          {userMenuOpen && (
            <div className="absolute top-full right-0 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2.5 text-sm hover:bg-gray-50 rounded-t-lg"
              >
                <UserIcon size={16} /> Mon profil
              </button>
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-danger hover:bg-red-50 rounded-b-lg"
              >
