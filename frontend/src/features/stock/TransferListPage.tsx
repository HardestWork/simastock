            ...
            <tbody>
              {data?.results.map((transfer) => (
                <tr key={transfer.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium text-gray-900">{transfer.from_store_name}</td>
                  <td className="px-4 py-3 text-gray-700">{transfer.to_store_name}</td>
                  <td className="px-4 py-3">
                    <StatusBadge status={transfer.status} />
                  </td>
                  <td className="px-4 py-3 text-gray-700">{transfer.created_by_name ?? '-'}</td>
                  <td className="px-4 py-3">
                    <Link
