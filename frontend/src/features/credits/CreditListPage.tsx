...
export default function CreditListPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Comptes credit</h1>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-600">Sante</th>
                ...
                >
                  <td className="px-4 py-3">
                    ...
                    {account.customer_phone && (
                      <div className="text-xs text-gray-500">{account.customer_phone}</div>
                    )}
                  </td>
            ...
            <div className="w-full max-w-lg bg-white rounded-xl border border-gray-200 shadow-xl">
              <div className="flex items-start justify-between gap-4 p-5 border-b border-gray-200">
                <div className="min-w-0">
                  <div className="text-sm text-gray-500">Encaisser un paiement</div>
