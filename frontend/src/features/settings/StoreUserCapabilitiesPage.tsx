...
const ROLE_CAPABILITY_WHITELIST: Record<UserRole, Capability[]> = {
  ...
  SALES: ['CAN_SELL', 'CAN_OVERRIDE_PRICE', 'CAN_MANAGE_LEADS', 'CAN_MANAGE_OPPORTUNITIES', 'CAN_LOG_ACTIVITY'],
  CASHIER: ['CAN_CASH', 'CAN_OVERRIDE_PRICE', 'CAN_CREATE_EXPENSE', 'CAN_VIEW_EXPENSE_REPORTS'],
  SALES_CASHIER: ['CAN_SELL', 'CAN_CASH', 'CAN_OVERRIDE_PRICE', 'CAN_CREATE_EXPENSE', 'CAN_VIEW_EXPENSE_REPORTS'],
  STOCKER: ['CAN_STOCK'],
};
