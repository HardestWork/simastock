...
export default function RoleListPage() {
  ...
  const createMut = useMutation({
    ...
    onError: () => setFormError('Erreur lors de la creation du role.'),
  });
  ...
  const updateMut = useMutation({
    ...
    onError: () => setFormError('Erreur lors de la mise a jour du role.'),
  });
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Roles personnalises</h1>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-500 font-medium">Aucun role personnalise</p>
