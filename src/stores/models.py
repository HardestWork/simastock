...
FEATURE_FLAG_LABELS = {
  ...
  "commercial_pipeline": "Pipeline commercial B2B",
  "commercial_ai": "IA commerciale",
  "commercial_incentives": "Primes commerciales",
  "commercial_exports": "Exports module commercial",
  "hrm_management": "Ressources humaines",
...
FEATURE_FLAG_DEFAULTS = {
  ...
  "commercial_ai": True,
  "commercial_incentives": True,
  "commercial_exports": True,
  "hrm_management": True,
