...
MODULE_DESCRIPTIONS = {
    ...
    "HRM": "Ressources humaines: employes, conges, pointage, paie.",
    "COMMERCIAL": "CRM B2B terrain: prospects, pipeline, relances, primes.",
...
PLAN_DEFINITIONS = [
    ...
    },
    {
        ...
        "modules": {"CORE", "SELL", "CASH", "STOCK", "CUSTOMER", "PURCHASE", "EXPENSE", "HRM", "COMMERCIAL", "ALERTS"},
    },
    {
        "code": "PERFORMANCE",
        "name": "Performance",
